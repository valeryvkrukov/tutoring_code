...
<?php
$searchBy = array('student_name' => 'Student Name', 'first_name' => 'Client First Name', 'last_name' => 'Client Last Name');
                ...
                <table class="table  table-bordered hidden-xs hidden-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{SCT::getClientName($student->user_id)->email}}</td>
                      <td>{{SCT::getClientName($student->user_id)->phone}}</td>
