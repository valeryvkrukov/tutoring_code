                        ...
                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                          ...
                          <g id="Front">
                            <g id="CardBackground">
                              ...
                              <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">**** **** **** {{ $userplan->card_last_four}}</text>
                              <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">{{ $userplan->f_name}}</text>
                                    ...
                                    <g id="Back">
                                      <g id="Page-1_2_">
                                        ...
                                        <g>
                                          ...
                                          <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">{{ $userplan->f_name}}</text>
                                        </g>
                                      </svg>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-container" style="margin-left: 10rem; display: none;">
...
@endif
  ...
  name.addEventListener('input', function () {
      if (name.value.length == 0) {
          document.getElementById('svgname').innerHTML = 'Zeeshan';
          document.getElementById('svgnameback').innerHTML = 'Zeeshan';
      } else {
