                  ...
                  <div class="col-md-12">
                    <div class="form-group undefined">
                      <div class="sc-iujRgT hUHAcY">
                        ...
                        <div class="sc-jhAzac iGbrby">
                          <label class="sc-bAeIUo fuksr">
                            <input type="checkbox" class="sc-bMVAic kyrrfd" value="Bookkeeping"  name="service_required[]" @if($service_required) @foreach($service_required as $data2) {{$data2 == 'Bookkeeping' ? 'checked="checked"' : '' }} @endforeach @endif>
                            <div class="sc-gqPbQI ilsJbL">
                              <div class="sc-hORach kMXQwc"></div>
                            </div>
                          </label>Bookkeeping
